...
let compare, states, nodes1, nodes2
let addCost, deleteCost, editCost


const defaultAddCost = function () {
	return 1
}

const defaultDeleteCost = function () {
	return 1
}

const defaultEditCost = function () {
	return 1
}
...
const initArrayElement = function (states, i, j, k) {
...
const setState = function (i1, i, j1, j, result) {
	states[i1][i][j1][j] = result
	return result
}


const getValue = function (i1, i, j1, j) {
	return getState(i1, i, j1, j).value
}


const getState = function (i1, i, j1, j) {
...
const getSteps = function (steps, state) {
...
const iterateAncestors = function (node, operation) {
	while (true) {
...
const diff = function (root1, root2, options) {
	init()
